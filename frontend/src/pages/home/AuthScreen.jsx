	...
	return (
		<div className='hero-bg relative'>
			...
			<div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
				<h1 className='text-4xl md:text-5xl font-bold mb-4'>Unlimited access to movies, TV shows, and more!</h1>
				<p className='text-lg mb-4'>Watch anytime, anywhere, Cancel whenever you want.</p>
				<p className='mb-4'>Ready to start watch? Enter your email to create a new account or restart your membership.</p>
			...
			<div className='py-10 bg-black text-white'>
              ...
              '
					...
					<div className='flex-1 md:text-left text-center'>
						...
						<p className='text-lg md:text-xl'>
							Save your favorites and have something to watch anytime, anywhere.
						</p>
					</div>
				</div>
			</div>
        ...
        '
				>
					...
					{/* right */}
					<div className='flex-1 text-center md:text-left'>
						<h2 className='text-4xl md:text-5xl font-extrabold mb-4'>Create Kid-Friendly Profiles</h2>
						<p className='text-lg md:text-xl'>
						Let kids embark on adventures with their favorite characters in a personalized space—absolutely free with your membership.
						</p>
					</div>
				</div>
			</div>
